...
<style>
                            ...
                            <div class="col-12">
                                ...
                                <ul class="nav nav-tabs dashboard-tabs" id="dashboardTabs" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a href="{{route('user_seller_dashboard')}}" class="nav-link" id="groups-tab">
                                            Groups <span>({{count($group_wise_list_count)}})</span>
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a href="{{ route('seller_all_inquiries') }}" class="nav-link {{ (request()->is('seller/all-inquiries*')) ? 'active' : '' }}" id="allinquiries-tab" >
                                            All Inquiries <span>({{$all_inquery_count}})</span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a  href="{{ route('seller_pending_inquiries') }}" class="nav-link {{ (request()->is('seller/pending-inquiries*')) ? 'active' : '' }}" id="pendingresults-tab">
                                            Pending Results <span>({{count($pending_inquiries_count)}})</span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a  href="{{ route('seller_confirmed_inquiries') }}" class="nav-link {{ (request()->is('seller/confirmed-inquiries*')) ? 'active' : '' }}" id="confirmed-tab">
                                            Confirmed <span>({{count($confirmed_inquiries_count)}})</span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a  href="{{ route('seller_history_inquiries') }}" class="nav-link {{ (request()->is('seller/history-inquiries*')) ? 'active' : '' }}" id="history-tab">
                                            History <span>({{$rejected_inquiries_count}})</span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <script>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.status == 200) {
                                ...
                                $('#seller_new_quote_time_up').show();
                                $('#seller_new_quote_time_up').text('Time up! Your last quote was not recorded.');
                                setTimeout(function() {
                                    $("#New_Quotes_Modal").modal('hide');
        ...
        function cancelInquiryModal(id){
            $('#cancel_inquiry_id').val(id);
        }
