                                ...
                                <ul class="nav nav-tabs dashboard-tabs" id="dashboardTabs" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a  href="{{ route('seller_pending_inquiries') }}" class="nav-link {{ (request()->is('seller/pending-inquiries*')) ? 'active' : '' }}" id="pendingresults-tab">
                                            Pending Results ({{$pending_inquiries_count}})
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <form action="" method="GET" id="resetform">
                            ...
                            <div class="row filter-cta-fow">
                                <div class="col-12 text-end">
                                    ...
                                    <a href="{{route('seller_pending_inquiries')}}" class="btn btn-cta btn-animated" id="resetURL">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="input-buyer-td">
                                                                            {{$item['buyer_name']}}
                                                                            <p>{{$item['country_code']}}{{$item['buyer_mobile']}}</p>
                                                                            {{$item['location']}}
                                                                        </td>
                                                                            ...
                                                                            <div class="description-wrap">
                                                                                <ul class="input-data-list">
                                                                                    <li>
                                                                                        ...
                                                                                        <p>
                                                                                            @if (isset($item['minimum_quote_amount']) && is_numeric($item['minimum_quote_amount']))
                                                                                                {{ number_format($item['minimum_quote_amount'], 2, '.', ',') }}
                                                                                            @else
                                                                                                ----
                                                                                            @endif
                                                                                            &amp;
                                                                                            @if (isset($item['maximum_quote_amount']) && is_numeric($item['maximum_quote_amount']))
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="quotes-supplier-td">
                                                                            <div class="quote">
                                                                                <a href="javacsript:void(0)" data-bs-toggle="modal" data-bs-target="#allQuotesModal{{$item['id']}}" class="quotes-left">{{$item['left_quotes']}} Quotes Left</a>
                                                                                <div class="quote-diff">Last Quote: {{$item['last_quotes']}}</div>
                                                                            ...
                                                                            <div class="modal fade all-quotes-modal" id="allQuotesModal{{$item['id']}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            <h3 class="content-heading">{{$item['my_business_name']}}</h3>
                                                                                            <div class="quotes-list-wrapper">
                                                                                                Quotes: 
                                                                                                <ul class="quotes-list">
                                                                                                    @foreach ($item['my_last_three_quotes'] as $val)
                                                                                                    <li>{{$val}}</li>
                                                                                                    @endforeach
                                                                                                </ul>
                                                                                            </div>
