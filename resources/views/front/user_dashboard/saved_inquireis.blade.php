    ...
    <div class="inner-page">
        ...
        <section class="user-dashboard">
            ...
            <div class="tab-content dashboard-tab-content">
                <div class="tab-pane fade show active" id="savedinquiries" role="tabpanel" aria-labelledby="savedinquiries-tab" tabindex="0">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <ul class="dashboard-groups">
                                    @foreach ($saved_inquiries as $item)
                                        <li class="item">
                                            <div class="group-icon">
                                                <img src="{{asset('frontend/assets/images/file-edit.png')}}" alt="Group">
                                            </div>
                                            <div class="group-name"> <span class="inquiry_title">{{ucwords($item->title)}}</span></div>
                                            <a href="{{ route('front.auction_inquiry_generation', ['inquiry_type' => 'saved-inquiry', 'inquiry_id' => Crypt::encrypt($item->id)]) }}" class="btn btn-animated btn-yellow btn-inquiry">Open Inquiry</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
