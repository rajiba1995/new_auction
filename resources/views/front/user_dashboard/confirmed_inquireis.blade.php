    ...
    <div class="inner-page">
        ...
        <section class="user-dashboard">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-row">
                                <h2 class="page-heading bg-theme">Buyer Dashboard</h2>
                            </div>
                            <ul class="nav nav-tabs dashboard-tabs" id="dashboardTabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a href="{{route('user_buyer_dashboard')}}" class="nav-link {{ (request()->is('buyer/groups*')) ? 'active' : '' }}" id="groups-tab">
                                        Groups <span>({{count($group_wise_list)}})</span>
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="{{route('buyer_saved_inquiries')}}" class="nav-link" id="savedinquiries-tab">
                                        Saved Inquiries <span>({{count($saved_inquiries)}})</span>
                                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="{{route('buyer_live_inquiries')}}" class="nav-link {{ (request()->is('buyer/live-inquiries*')) ? 'active' : '' }}" id="liveinquiries-tab">
                                        Live Inquiries <span>({{count($live_inquiries)}})</span>
                                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="{{route('buyer_pending_inquiries')}}" class="nav-link {{ (request()->is('buyer/pending-inquiries*')) ? 'active' : '' }}" id="pendingresults-tab">
                                            Pending Results <span>({{count($pending_inquiries_data)}})</span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="{{route('buyer_confirmed_inquiries')}}" class="nav-link {{ (request()->is('buyer/confirmed-inquiries*')) ? 'active' : '' }}" id="confirmed-tab">
                                            Confirmed <span>({{count($confirmed_inquiry_data)}})</span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="{{route('buyer_cancelled_inquiries')}}" class="nav-link {{ (request()->is('buyer/cancelled-inquiries*')) ? 'active' : '' }}" id="cancelled-tab">
                                            Cancelled <span>({{count($cancelled_inquiry_data)}})</span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <form method="GET" id="resetForm">
                    ...
                    <div class="row filter-cta-fow">
                        <div class="col-lg-5 col-12 text-end">                          
                            ...
                            <a href="{{route('export_confirm_inquiries',['start_date'=>request()->input('start_date'),'end_date'=>request()->input('end_date'),'seller'=>request()->input('seller'),'keyword'=>request()->input('keyword')])}}"  class="btn btn-cta btn-animated" id="exportButton">
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="16" x="0" y="0" viewBox="0 0 512.449 512.449" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                                    <g>
                                        <path d="M152.083 286.805c7.109-8.155 1.318-20.888-9.501-20.888H110.19a147.458 147.458 0 0 1-.329-9.692c0-80.706 65.658-146.364 146.363-146.364 38.784 0 74.087 15.168 100.304 39.877l45.676-53.435c-39.984-36.577-91.44-56.612-145.98-56.612-57.838 0-112.214 22.524-153.112 63.421-40.897 40.898-63.421 95.274-63.421 153.112 0 3.243.081 6.473.222 9.692H12.629c-10.819 0-16.611 12.733-9.501 20.888l61.549 70.6 12.928 14.829 46.416-53.242zM509.321 245.614l-45.907-52.658-28.57-32.771-40.791 46.789-33.686 38.64c-7.109 8.155-1.318 20.888 9.501 20.888h32.354c-5.293 75.928-68.748 136.086-145.997 136.086-33.721 0-64.811-11.469-89.586-30.703l-45.679 53.439c38.267 30.731 85.479 47.434 135.266 47.434 57.838 0 112.214-22.523 153.112-63.421 38.466-38.466 60.672-88.856 63.177-142.834h27.306c10.818-.001 16.609-12.734 9.5-20.889z" fill="#ffffff" opacity="1" data-original="#000000" class=""></path>
                                    </g>
            ...
            <div class="tab-content dashboard-tab-content">
                <div class="tab-pane fade show active" id="confirmed" role="tabpanel" aria-labelledby="pendingresults-tab" tabindex="0">
                                    ...
                                    <table class="table inquiry-wrapper-table">
                                        ...
                                        <tbody class="dashboard_groups">
                                            @if($confirmed_inquiries)
                                                ...
                                                <tr class="item">
                                                    <td class="input-table-column" colspan="4">
                                                    ...
                                                    <td class="output-table-column" colspan="5">
                                                        <table class="table output-table">
                                                            <tbody>
                                                                    @if($item['allotment_type']==1)
                                                                    <tr>
                                                                        <td colspan="5" class="text-center">
                                                                            <p class="badge btn-red">Offline Allot Seller</p>
                                                                            @php
                                                                                $AllotOffline = App\models\AllotOffline::where('id', $item['allot_seller'])->first();
                                                                            @endphp
                                                                            <ul style="list-style: none;">
                                                                                <li>Name: <strong>{{$AllotOffline?$AllotOffline->name:""}}</strong></li>
                                                                                <li>Mobile: <strong>{{$AllotOffline?$AllotOffline->mobile:""}}</strong></li>
                                                                                <li>
                                                                                    <a href="javascript:void(0)" class="btn btn-yellow btn-allot" title="Allotment amount">  {{ number_format($item['inquiry_amount'], 2, '.', ',') }}
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
                                                                        </td>
                                                                    ...
                                                                    @if(count($item['seller_data'])>0)
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="suppliers-td">
                                                                                <div class="supplier">
                                                                                    <p>{{$seller_item['business_name']}}</p>
                                                                                    <p>{{$seller_item['name']}}</p>
                                                                                    <a href="javascript:void();">{{$seller_item['country_code']}}{{$seller_item['mobile']}}</a>
                                                                                    <label>L{{$seller_key+1}}</label>
                                                                                </div>
                                                                            </td>
                                                                            <td class="quotes-td">
                                                                                <div class="quote">
                                                                            ...
                                                                            <td class="comments-td">
                                                                                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#viewCommentModal{{$item['id']}}{{$seller_item['id']}}" class="btn btn-view btn-view-comment">View Comment</a>

                                                                                <div class="modal fade view-comment-modal" id="viewCommentModal{{$item['id']}}{{$seller_item['id']}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                    <div class="modal-dialog">
                                                                                        <div class="modal-content">
                                                                                            <div class="modal-header">
                                                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                <h3 class="content-heading">{{$seller_item['business_name']}}</h3>
                                                                                                @if(count($seller_item['seller_comments_data']))
                                                                                                    @foreach ($seller_item['seller_comments_data'] as $item_comment)
                                                                                                        <p>{{$item_comment->comments}}</p>
                                                                                                    @endforeach
                                                                                                @endif
                                                                                            </div>
                                                                                        </div>
                                                                            ...
                                                                            <td class="actions-td">
                                                                                @if($item['allotment_type']==0)
                                                                                                ...
                                                                                                <div class="modal-content">
                                                                                                    ...
                                                                                                    <div class="modal-body">
                                                                                                        ...
                                                                                                        <div class="allot-amount">
                                                                                                            ...
                                                                                                            <input type="hidden" name="type" class="form-control" value="new">
                                                                                    ...
                                                                                    @else
                                                                                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#OldstartAllotModal{{$item['inquiry_id']}}{{$seller_item['id']}}" class="btn btn-yellow btn-allot">  
                                                                                        <img src="{{asset('frontend/assets/images/green-circle-tick.png')}}" alt="Allot Offline">{{$item['inquiry_amount']}}</a>
                                                                                        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#viewQuoteModal{{$item['id']}}{{$seller_item['id']}}" class="mt-2 btn btn-view-details btn-view-comment">Details</a>
                                                                                        <div class="modal fade view-comment-modal" id="viewQuoteModal{{$item['id']}}{{$seller_item['id']}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                            <div class="modal-dialog">
                                                                                                <div class="modal-content">
                                                                                                    <div class="modal-header">
                                                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                                        ...
                                                                                        <div class="modal fade allot-rate-modal start-allot" id="OldstartAllotModal{{$item['inquiry_id']}}{{$seller_item['id']}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                            <div class="modal-dialog">
                                                                                                <form action="{{route('live_inquiry_seller_allot')}}" method="POST" id="seller_allot_form{{$item['id']}}">
                                                                                                    @csrf
                                                                                                    <div class="modal-content">
                                                                                                        ...
                                                                                                        <div class="modal-body">
                                                                                                            <h4 class="content-heading text-danger">If you want to change the previous rate*</h4>
                                                                                                            <h4 class="content-heading">Please give the Rate at which you want to Allot(in Rs) *</h4>
                                                                                                            <div class="allot-amount">
                                                                                                                <input type="hidden" name="allotrate" class="form-control" value="yes">
                                                                                                                <input type="hidden" name="type" class="form-control" value="old">
                                                                                                                <input type="hidden" name="inquiry_id" class="form-control" value="{{$item['id']}}">
                                                                                                                <input type="hidden" name="bidder_id" class="form-control" value="{{$seller_item['seller_id']}}">
                                                                                                                <input type="text" name="allot_amount" class="form-control" onkeyup="validateAmount(this, '{{$item['id']}}')" value="{{$item['inquiry_amount']}}" required>
                                                                                                                <div id="{{$item['id']}}error-message" style="color: red;"></div>
                                                                                                                <div class="text-start">
                                                                                                                    <label for="">Reason *</label>
                                                                                                                    <textarea name="reallot_reason" rows="2" class="form-control" style="border-color: #0076D7;" required></textarea>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <button type="submit" class="btn btn-animated btn-submit w-75">Submit</button>
                                                                                                        </div>
                                                                ...
                                                                <tr>
                                                                    <td class="other-actions-td">
                                                                        @if($item['bill'])
                                                                            ...
                                                                            <div class="billing-date-time">{{date('d M Y, h:i a', strtotime($item['bill_at']))}}</div>
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                            </tbody>
...
@section('script')
<script>
    function validateAmount(input, id) {
        var amount = $(input).val();
        var errorMessageElement = $('#' + id + 'error-message'); // Select the error message element using the provided id
        
        var isValidAmount = /^(\d+|\d{1,3}(,\d{3})*)(\.\d{1,2})?$/.test(amount);
        
        if (!isValidAmount) {
            errorMessageElement.text('Invalid amount');
            // Prevent the form from being submitted
            $('#seller_allot_form'+id+'').submit(function(event) {
                event.preventDefault();
            });
        } else {
                errorMessageElement.text('');
            // Remove any previously bound submit event handlers
            $('#seller_allot_form' + id).off('submit');
        }
    }
