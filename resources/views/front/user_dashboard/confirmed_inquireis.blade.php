        ...
        <section class="user-dashboard">
            <div class="top-section user-dashboard-top-section">
                <div class="container">
                    ...
                    <form method="GET" id="filterConfirmForm">
                    <div class="row filter-row" id="group_list">
                        ...
                        <div class="col-lg-2 col-12">
                            <button type="button" class="btn btn-sm btn-danger" id="ConfirmclearButton">Clear</button>
                        </div>
                    </div>
                </form>
                </div>
...
<script>
    ...
    document.getElementById('ConfirmclearButton').addEventListener('click', function() {
        document.getElementById('filterConfirmForm').reset();
