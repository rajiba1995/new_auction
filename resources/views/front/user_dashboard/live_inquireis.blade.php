    ...
    <div class="inner-page">
        ...
        <section class="user-dashboard">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-row">
                                <h2 class="page-heading bg-theme rajib">Buyer Dashboard</h2>
                            </div>
            ...
            <div class="tab-content dashboard-tab-content">
                <div class="tab-pane fade show active" id="liveinquiries" role="tabpanel" aria-labelledby="liveinquiries-tab" tabindex="0">
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <h3 class="content-heading" id="participants_name{{$value->id}}">{{$value->business_name}}</h3>
...
<div class="modal fade buyer-details-modal" id="buyerDetailsModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="modal-body">
                <div class="buyer-details">
                    ...
                    <div class="row heading-row">
                        <div class="col-12">
                            <h5>Date of Inquiry</h5>
                        </div>
                    </div>
                    <div class="row info-row">
                        <div class="col-sm-6 col-12 d-flex align-items-center">
                            <label>Start Date:</label>
                            <p class="ps-3">25 jan, 2024</p>
                        </div>
                        <div class="col-sm-6 col-12 d-flex align-items-center">
                            <label>End Date:</label>
                            <p class="ps-3">28 jan, 2024</p>
                        </div>
                    </div>
                    <div class="row heading-row">
                        <div class="col-12">
                            <h5>Time of Inquiry</h5>
                        </div>
                    </div>
                    <div class="row info-row">
                        <div class="col-sm-6 col-12 d-flex align-items-center">
                            <label>Start Time:</label>
                            <p class="ps-3">10.15 am</p>
                        </div>
                        <div class="col-sm-6 col-12 d-flex align-items-center">
                            <label>End Time:</label>
                            <p class="ps-3">12.00 pm</p>
                        </div>
                    </div>
                    <div class="row info-row">
                        <div class="col-sm-6 col-12">
...
<div class="modal fade view-file-modal viewFileModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
...
<div class="modal fade allot-rate-modal start-allot" id="startAllotModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
...
<div class="modal fade all-quotes-modal allQuotesModal"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3 class="content-heading" id="participants_name"></h3>
                <div class="quotes-list-wrapper">
                    Quotes: 
                                ...
                                $.each(item.seller_data, function(key, value) {
                                    ...
                                    htmlString += '<tr class="'+rowClass+'">';
                                        ...
                                        '<div class="modal fade view-comment-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">'+
                                            ...
                                            '</div>'+
                                        '</div>'+
                                        '<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target=".viewFileModal" class="btn btn-view btn-view-yellow btn-file-download " onclick="allFileModal(' + value.id + ')">' +
                                        '<svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">' +
                                        '<path d="M6 6.75L2.25 3.9375L3.3 3.12187L5.25 4.58437V0H6.75V4.58437L8.7 3.12187L9.75 3.9375L6 6.75ZM1.5 9C1.0875 9 0.734375 8.88984 0.440625 8.66953C0.146875 8.44922 0 8.18437 0 7.875V6.1875H1.5V7.875H10.5V6.1875H12V7.875C12 8.18437 11.8531 8.44922 11.5594 8.66953C11.2656 8.88984 10.9125 9 10.5 9H1.5Z" fill="#FFB800"/>' +
                                        '</svg>' +
                                        'Download File' +
                                        '</a>' +
                                        '<div class="modal fade view-file-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">'+
                                            '<div class="modal-dialog">'+
                                                '<div class="modal-content">'+
                                                    '<div class="modal-header">'+
                                                        '<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>'+
                                                    '</div>'+
                                                    '<div class="modal-body" id="viewFileModal' + value.id + '">'+
                                                        '<h3 class="content-heading">Comments from '+ value.business_name.substr(0, 50) +'</h3>'+
