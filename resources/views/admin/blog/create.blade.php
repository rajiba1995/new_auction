            ...
            <div class="row">
                <div class="col-md-6 col-12">
                    ...
                    <div class="form-wrap mb-3">
                        ...
                        <textarea type="text" class="form-control ckeditor" name="short_description" id="short_description">{{old('short_description')}}</textarea>
                        @error('short_description')<div class="text-danger">{{ $message }}</div>@enderror
                    </div>
                    <div class="form-wrap mb-3">
                        <label for="">Long Description</label>
                        <textarea type="text" class="form-control ckeditor" name="long_description" id="long_description">{{old('long_description')}}</textarea>
