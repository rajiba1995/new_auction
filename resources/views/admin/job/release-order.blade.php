    ...
    <div id="printableArea">
        <div class="top-info-panel">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width:80%;">
                                <table style="width: 100%;table-layout:fixed;">
                                    <tbody>
                                        <tr><td style="text-transform:uppercase;font-size:18px;font-weight:500;text-align:center;line-height:20px;padding:5px;">Inspection Syndicate Of India Private Limited</td></tr>
                                        <tr><td style="text-transform:uppercase;font-size:12px;font-weight:500;text-align:center;line-height:10px;padding:5px;">(An ISO 9001 Organisation)</td></tr>
                                        <tr><td style="font-size:12px;font-weight:500;text-align:center;line-height:10px;padding:5px;">(Consultants &amp; Surveyors)</td></tr>
                                        <tr><td style="text-transform:uppercase;font-size:12px;font-weight:500;text-align:center;line-height:10px;padding:5px;">Head Office:</td></tr>
                                        <tr><td style="text-transform:uppercase;font-size:12px;font-weight:500;text-align:center;line-height:10px;padding:5px;">"Ergo Brilliant Tower" (Unit-1002), 10th Floor, GP Block</td></tr>
                                        <tr><td style="text-transform:uppercase;font-size:12px;font-weight:500;text-align:center;line-height:10px;padding:5px;">Sector-V, Salt Lake, Kolkata-700091, West Bengal, India</td></tr>
                                        <tr><td style="font-size:12px;font-weight:500;text-align:center;line-height:10px;padding:5px;">Phone: 033-4095-1400 / 1404 / 1409</td></tr>
                                        <tr><td style="text-transform:uppercase;font-size:12px;font-weight:500;text-align:center;line-height:10px;padding:5px;padding-bottom:20px;">E-mail: inspection@isoipl.in, isoipl.ho@gmail.com, Website: www.isoipl.co.in</td></tr>
                                    </tbody>
                                </table>
                            </td>
            ...
            <div class="info-box" style="margin-right:30px;margin-bottom:12px;">
                ...
                <p style="font-size:12px;line-height:9px;"></p>
            </div>
            <div class="info-box" style="margin-right:30px;margin-bottom:12px;">
                    ...
                    <tbody>
                        ...
                        @if ($FetchFinalJobData->dimension_length>0 && $FetchFinalJobData->dimension_width>0)
                            <tr>
                                ...
                                <td colspan="5" class="text-start" style="line-height: 8px;font-size: 10px;padding:5px 20px;">DIMENSIONS</td>
                            </tr>
                            <tr>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td>{{$FetchFinalJobData->art_work}}</td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td>{{$FetchFinalJobData->ink_quality}}</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td style="line-height: 8px;font-size: 10px;padding:5px 20px;">Remarks:</td>
                            <td colspan="5" style="line-height: 8px;font-size: 10px;padding:5px 20px;">{{$FetchFinalJobData->remarks}}</td>
                        </tr>
                        <tr>
