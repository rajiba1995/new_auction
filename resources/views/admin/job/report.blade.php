...
<div class="inner-content">
    <div class="heading-row mb-2 ">
        ...
        <div class="d-flex">
            ...
            <a href="{{route('admin.job.report.pdf', $job->id)}}" class="btn btn-primary btn-sm mx-2">
               ...
               @if ($job->package_id==2)
                    <table style="width: 100%;table-layout: fixed;">
                        <tbody>
                            ...
                            <tr>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">LENGTH WAY{{$TextValuePack2->dimension_length_text?'('.$TextValuePack2->dimension_length_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">WIDTH WAY{{$TextValuePack2->dimension_width_text?'('.$TextValuePack2->dimension_width_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">OPENING{{$TextValuePack2->value_size_opening_text?'('.$TextValuePack2->value_size_opening_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">DEPTH{{$TextValuePack2->value_size_depth_text?'('.$TextValuePack2->value_size_depth_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">LENGTH WAY{{$TextValuePack2->mesh_length_text?'('.$TextValuePack2->mesh_length_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">WIDTH WAY{{$TextValuePack2->mesh_weight_text?'('.$TextValuePack2->mesh_weight_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">TOP{{$TextValuePack2->folding_top_text?'('.$TextValuePack2->folding_top_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">BOTTOM{{$TextValuePack2->folding_bottom_text?'('.$TextValuePack2->folding_bottom_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">LENGTH WAY{{$TextValuePack2->breaking_length_text?'('.$TextValuePack2->breaking_length_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">ELONGATION %{{$TextValuePack2->breaking_length_elongation_text?'('.$TextValuePack2->breaking_length_elongation_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">WIDTH WAY{{$TextValuePack2->breaking_width_text?'('.$TextValuePack2->breaking_width_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">ELONGATION %{{$TextValuePack2->breaking_width_elongation_text?'('.$TextValuePack2->breaking_width_elongation_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">TOP{{$TextValuePack2->seam_top_text?'('.$TextValuePack2->seam_top_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">BOTTOM{{$TextValuePack2->seam_bottom_text?'('.$TextValuePack2->seam_bottom_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">SL. NO.{{$TextValuePack2->struss_sl_text?'('.$TextValuePack2->struss_sl_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">KGS.{{$TextValuePack2->struss_kgs_text?'('.$TextValuePack2->struss_kgs_text.')':""}}</td>
                            </tr>
                            <tr>
               ...
               {{--Non Stitchable Bag --}}
                    <table style="width: 100%;table-layout: fixed;">
                        <tbody>
                            ...
                            <tr>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">LENGTH WAY{{$TextValuePack1->dimension_length_text?'('.$TextValuePack1->dimension_length_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">WIDTH WAY{{$TextValuePack1->dimension_width_text?'('.$TextValuePack1->dimension_width_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">LENGTH{{$TextValuePack1->value_size_opening_text?'('.$TextValuePack1->value_size_opening_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">WIDTH{{$TextValuePack1->value_size_depth_text?'('.$TextValuePack1->value_size_depth_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">OS{{$TextValuePack1->patch_length_os_text?'('.$TextValuePack1->patch_length_os_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">DS{{$TextValuePack1->patch_length_ds_text?'('.$TextValuePack1->patch_length_ds_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">OS{{$TextValuePack1->patch_width_os_text?'('.$TextValuePack1->patch_width_os_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">DS{{$TextValuePack1->patch_width_ds_text?'('.$TextValuePack1->patch_width_ds_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">LENGTH WAY{{$TextValuePack1->mesh_length_text?'('.$TextValuePack1->mesh_length_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">WIDTH WAY{{$TextValuePack1->mesh_weight_text?'('.$TextValuePack1->mesh_weight_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">LENGTH WAY{{$TextValuePack1->breaking_length_text?'('.$TextValuePack1->breaking_length_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">ELONGATION %{{$TextValuePack1->breaking_length_elongation_text?'('.$TextValuePack1->breaking_length_elongation_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">WIDTH WAY{{$TextValuePack1->breaking_width_text?'('.$TextValuePack1->breaking_width_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">ELONGATION %{{$TextValuePack1->breaking_width_elongation_text?'('.$TextValuePack1->breaking_width_elongation_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">OS{{$TextValuePack1->patch_strength_os_text?'('.$TextValuePack1->patch_strength_os_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">DS{{$TextValuePack1->patch_strength_ds_text?'('.$TextValuePack1->patch_strength_ds_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">SL. NO.{{$TextValuePack1->bale_weight_sl_text?'('.$TextValuePack1->bale_weight_sl_text.')':""}}</td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">WT.{{$TextValuePack1->bale_weight_wt_text?'('.$TextValuePack1->bale_weight_wt_text.')':""}}</td>
                            </tr>
                            <tr>
                                <td colspan="2" style="font-size:8px;word-break:break-all;padding:2px !important;"><strong>Required</strong></td>
                                <td style="font-size:8px;word-break:break-all;padding:2px !important;">{{$AllRequiredValue->dimension_length}}{{$AllRequiredValue->dimension_length_plus?'+'.$AllRequiredValue->dimension_length_plus:''}}{{$AllRequiredValue->dimension_length_minus?'-'.$AllRequiredValue->dimension_length_minus:''}}</td>
