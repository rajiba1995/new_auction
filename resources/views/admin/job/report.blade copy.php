                    ...
                    <tbody>
                        <tr>
                            <td style="width:15%;text-align:left;vertical-align:top;">
                                <img src="https://demo90.co.in/dev/inspection_syndicate/public/admin/assets/images/is_logo.png">
                            </td>
                            <td style="width:70%;">
                                <table style="width: 100%;table-layout:fixed;">
                                    <tbody>
            ...
            <div>
               ...
               @if ($job->package_id==2)
                    <table style="width: 100%;table-layout: fixed;">
                        <tbody>
                            <tr>
                                <td rowspan="2" colspan="2" class="action_btn" style="font-size:8px;word-break:break-all;padding:2px !important;">SL. NO.</td>
                            ...
                            <form action="{{route('admin.job.report.update')}}" method="POST">
                                ...
                                <tr class="package_dimension">
                                    ...
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="dimension_length" value="{{$item->dimension_length}}" style=""></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="dimension_width" value="{{$item->dimension_width}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="value_size_opening" value="{{$item->value_size_opening}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="value_size_depth" value="{{$item->value_size_depth}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="bag_weight" value="{{$item->bag_weight}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="stitching_dm" value="{{$item->stitching_dm}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="mesh_length" value="{{$item->mesh_length}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="mesh_weight" value="{{$item->mesh_weight}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="folding_top" value="{{$item->folding_top}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="folding_bottom" value="{{$item->folding_bottom}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="tape_width" value="{{$item->tape_width}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="breaking_length" value="{{$item->breaking_length}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="breaking_length_elongation" value="{{$item->breaking_length_elongation}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="breaking_width" value="{{$item->breaking_width}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="breaking_width_elongation" value="{{$item->breaking_width_elongation}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="seam_top" value="{{$item->seam_top}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="seam_bottom" value="{{$item->seam_bottom}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="struss_sl" value="{{$item->struss_sl}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="struss_kgs" value="{{$item->struss_kgs}}"></td>
                                    <td style="font-size:8px;padding:2px !important;"><input type="text" class="input_field" name="ash_content" value="{{$item->ash_content}}"></td>
                            ...
                            <tr>
                                ...
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->struss_sl, 1)}}</td>
                            ...
                            <tr>
                                ...
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->struss_sl_min, 1)}}</td>
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->struss_kgs_min, 1)}}</td>
                                <td style="font-size:8px;padding:2px !important;"></td>
                                <td style="font-size:8px;padding:2px !important;"></td>
                            </tr>
                            <tr>
                                ...
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->struss_sl_max, 1)}}</td>
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->struss_kgs_max, 1)}}</td>
                                <td style="font-size:8px;padding:2px !important;"></td>
                                <td style="font-size:8px;padding:2px !important;"></td>
                            </tr>
                            <tr>
                    ...
                    <table style="width: 100%;table-layout: fixed;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->bale_weight_sl, 1)}}</td>
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->bale_weight_wt, 1)}}</td>
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->air_permiabilty, 1)}}</td>
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->ash_content, 1)}}</td>
                                <td style="font-size:8px;padding:2px !important;"></td>
                            </tr>
                            <tr>
                                ...
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->bale_weight_sl_min, 1)}}</td>
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->bale_weight_wt_min, 1)}}</td>
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->air_permiabilty_min, 1)}}</td>
                                <td style="font-size:8px;padding:2px !important;"></td>
                                <td style="font-size:8px;padding:2px !important;"></td>
                            </tr>
                            <tr>
                                ...
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->bale_weight_sl_max, 1)}}</td>
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->bale_weight_wt_max, 1)}}</td>
                                <td style="font-size:8px;padding:2px !important;">{{round($finalValue->air_permiabilty_max, 1)}}</td>
                                <td style="font-size:8px;padding:2px !important;"></td>
                                <td style="font-size:8px;padding:2px !important;"></td>
                            </tr>
                            <tr>
                                <td colspan="25" style="font-size:8px;word-break:break-all;padding:2px !important;">
                                    <strong>REMARKS:</strong>
                                    pp (715x510,100x220mm)78gm 42x42 perdm full yellow colour Fabric BIRLA SMART ADVANCE COMPOSITE TRADE BRAND "-50Kg packing capacity..
                                    <br>Mrp-Blank, W.M.Y. is blank
                                </td>
