               ...
               <div class="mt-3">
                <form action="{{route('admin.job.update')}}" method="POST">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="unit_name" id="unit_name" class="form-control w-100 js-example-basic-single" data-placeholder="Select a unit">
                                ...
                                @foreach ($units as $item)
                                    <option value="{{$item->name}}" {{$data->unit_name==$item->name?"selected":""}}>{{$item->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3">
                     ...
                     <div class="row">
                        <div class="mb-3 col-md-6">
                            <label for="vendor_location" class="form-label">Location of Vendor</label>
                            <input type="text" class="form-control" name="vendor_location" id="vendor_location" value="{{old('vendor_location')?old('vendor_location'):$data->vendor_location}}" readonly>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input type="date" class="form-control" name="inspection_date" id="inspection_date" value="{{old('inspection_date')?old('inspection_date'):$data->inspection_date}}">
                      ...
                      <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" name="po_no" id="po_no" value="{{old('po_no')?old('po_no'):$data->po_no}}">
                            @error('po_no')<div class="text-danger">{{ $message }}</div>@enderror
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="lot_no" class="form-label">Lot No:</label>
                            <input type="text" class="form-control" name="lot_no" id="lot_no" value="{{old('lot_no')?old('lot_no'):$data->lot_no}}">
                      ...
                      <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" name="branding_side" id="branding_side" value="{{old('branding_side')?old('branding_side'):$data->branding_side}}">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" name="stitching_thread_colour" id="stitching_thread_colour" value="{{old('stitching_thread_colour')?old('stitching_thread_colour'):$data->stitching_thread_colour}}">
                      ...
                      <div class="row">
                        <div class="mb-3 col-md-3">
                            ...
                            <input type="text" class="form-control" name="quantity" id="quantity" value="{{old('quantity')?old('quantity'):$data->quality}}">
                          ...
                          <div class="mb-3 col-md-6">
                                ...
                                <select name="inspector_name" id="inspector_name" class="form-control w-100 js-example-basic-single" data-placeholder="Select a inspector">
                                    ...
                                    @foreach ($inspectors as $item)
                                        <option value="{{$item->id}}" {{$data->inspector_id==$item->id?"selected":""}}>{{$item->name}}</option>
                                    @endforeach
                                </select>
                      ...
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" name="quality" id="quality" rows="3">{{old('quality')?old('quality'):$data->quality}}</textarea>
...
<script>
    ...
    $(document).ready(function() {
        $('#vendor_name').on('change', function() {
            ...
            $.ajax({
                url: '/admin/job/vendor/fetchdata/' + selectedVendorId,
                type: 'GET',
                success: function(data) {
                    var location = data.result.location+', '+data.result.pincode+', '+data.result.state;
                    $('#ac_no').val(data.result.account_no);
