...
<div class="inner-content">
    <div class="report-table-box">
        <div class="heading-row">
            <h3>Vendors List</h3>
            <a href="{{route('admin.vendor.create')}}" class="btn btn-add">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-auto col-12" style="width:19%">
                        <input type="text" name="account" placeholder="Account no..." value="{{request()->query('account')}}" class="w-100"/>
                    </div>
                    <div class="col-lg-auto col-12">
                    ...
                    <div class="col-lg-auto col-12 text-end">
                        ...
                        <a href="{{route('admin.vendor.index')}}" class="btn btn-danger btn-sm"><i class="fa-solid fa-rotate"></i></a>
                    </div>
                </div>
            </div>
        </form>
            ...
            <tbody>
                @foreach ($data as $key =>$item)
                    <tr>
                        ...
                        <td>{{$item->location}},{{$item->state}},{{$item->pincode}}</td>
                        <td>
                            <a href="{{route('admin.vendor.status', $item->id)}}"><span class="badge rounded-pill {{$item->status==1?"bg-success":"bg-danger"}}">{{$item->status==1?"Active":"Inactive"}}</span></a>
                        </td>
                        <td>
                            {{-- <button type="button" class="btn btn-view" title="View"><i class="fa-regular fa-eye"></i></button> --}}
                            <a href="{{route('admin.vendor.edit', $item->id)}}" class="btn btn-edit" title="Edit"><i class="fa-solid fa-pen"></i></a>
